...
/*!
 * Generated using the Bootstrap Customizer (http://v3.bootcss.com/customize/?id=88eab2b6363086cf8ff551548c181f91)
 * Config saved to config.json and https://gist.github.com/88eab2b6363086cf8ff551548c181f91
 */
...
$("#nav li").hover(function(){
    $(this).find(".ht_updown").stop(true,true).slideDown(200);
},function(){
     $(this).find(".ht_updown").stop(true,true).slideUp(100);
})
// 老师下拉菜单
$(".login_teacher").hover(function(){
    $(this).find(".teacher_updown").stop(true,true).slideDown();
},function(){
     $(this).find(".teacher_updown").stop(true,true).slideUp();
})
// 学生下拉菜单
$(".login_student").hover(function(){
    $(this).find(".student_updown").stop(true,true).slideDown();
},function(){
     $(this).find(".student_updown").stop(true,true).slideUp();
})
...
$(".xuanfu ul li").hover(function(){
    $(this).find(".xuanfu_bottom").stop(true,true).fadeIn();    
},function(){
    $(this).find(".xuanfu_bottom").stop(true,true).fadeOut();
})
